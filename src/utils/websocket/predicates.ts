...
// State interface representing the relevant parts of ColonyTilesContext state
 ...
 */
export const isViewableTileUpdate = (tile: Tile, state: ColonyTilesState) =>
 ...
 */
export const isOpponentTakingTile = (tile: Tile, user: User | null, state: ColonyTilesState) =>
