...
export const useWebSocket = ({
  ...
  useEffect(() => {
    ...
    if ((connectionState === ConnectionState.DISCONNECTED || connectionState === ConnectionState.ERROR) && autoConnect) {
  ...
  }, [connectionState, autoConnect, autoReconnect, connect, reconnectAttempts]);
